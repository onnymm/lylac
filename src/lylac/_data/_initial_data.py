        ...
        [
                    ...
                    RELATION_ACTION_NAME.CREATE: [
                        {
                            ...
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.MODEL_ID: ctx.get_resource_id(REF.BASE_MODEL.BASE_USERS),
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_READ: True,
                        },
                        {
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.NAME: 'base_model__user',
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.MODEL_ID: ctx.get_resource_id(REF.BASE_MODEL.BASE_MODEL),
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_READ: True,
                        },
                        {
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.NAME: 'base_model_field__user',
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.MODEL_ID: ctx.get_resource_id(REF.BASE_MODEL.BASE_MODEL_FIELD),
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_READ: True,
                        },
                        {
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.NAME: 'base_model_field_selection__user',
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.MODEL_ID: ctx.get_resource_id(REF.BASE_MODEL.BASE_MODEL_FIELD_SELECTION),
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_READ: True,
                        },
                        {
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.NAME: 'base_model_data__user',
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.MODEL_ID: ctx.get_resource_id(REF.BASE_MODEL.BASE_MODEL_DATA),
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_READ: True,
                        },
                        {
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.NAME: 'base_model_data_process__user',
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.MODEL_ID: ctx.get_resource_id(REF.BASE_MODEL.BASE_MODEL_DATA_PROCESS),
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_READ: True,
                        },
                        {
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.NAME: 'base_model_data_process_step__user',
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.MODEL_ID: ctx.get_resource_id(REF.BASE_MODEL.BASE_MODEL_DATA_PROCESS_STEP),
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_READ: True,
                        },
                        {
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.NAME: 'base_model_data_process_step_record__user',
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.MODEL_ID: ctx.get_resource_id(REF.BASE_MODEL.BASE_MODEL_DATA_PROCESS_STEP_RECORD),
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_READ: True,
                        },
                        {
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.NAME: 'base_user_session__user',
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.MODEL_ID: ctx.get_resource_id(REF.BASE_MODEL.BASE_USER_SESSION),
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_READ: True,
                        },
                        {
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.NAME: 'base_user_access__user',
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.MODEL_ID: ctx.get_resource_id(REF.BASE_MODEL.BASE_USER_ACCESS),
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_READ: True,
                        },
                        {
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.NAME: 'base_user_groups__user',
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.MODEL_ID: ctx.get_resource_id(REF.BASE_MODEL.BASE_USER_GROUPS),
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_READ: True,
                        },
                        {
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.NAME: 'base_users_role__user',
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.MODEL_ID: ctx.get_resource_id(REF.BASE_MODEL.BASE_USERS_ROLE),
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_READ: True,
                        },
                        {
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.NAME: 'base_users_update_password__user',
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.MODEL_ID: ctx.get_resource_id(REF.BASE_MODEL.BASE_USERS_UPDATE_PASSWORD),
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_CREATE: True,
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_READ: True,
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_DELETE: True,
                        },
                    ],
                },
            },
            # Administrador de la estructura de la base de datos
            {
                ...
                MODEL_FIELD_NAME.BASE_USER_GROUPS.ACCESS_IDS: {
                    RELATION_ACTION_NAME.CREATE: [
                        {
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.NAME: 'base_model__admin',
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.MODEL_ID: ctx.get_resource_id(REF.BASE_MODEL.BASE_MODEL),
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_CREATE: True,
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_READ: True,
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_UPDATE: True,
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_DELETE: True,
                        },
                        {
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.NAME: 'base_model__admin',
                        ...
                        {
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.NAME: 'base_model_data__admin',
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.MODEL_ID: ctx.get_resource_id(REF.BASE_MODEL.BASE_MODEL_DATA),
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_CREATE: True,
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_READ: True,
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_UPDATE: True,
                        ...
                        {
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.NAME: 'base_model_data_process__admin',
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.MODEL_ID: ctx.get_resource_id(REF.BASE_MODEL.BASE_MODEL_DATA_PROCESS),
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_CREATE: True,
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_READ: True,
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_UPDATE: True,
                        ...
                        {
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.NAME: 'base_model_data_process_step__admin',
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.MODEL_ID: ctx.get_resource_id(REF.BASE_MODEL.BASE_MODEL_DATA_PROCESS_STEP),
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_CREATE: True,
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_READ: True,
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_UPDATE: True,
                        ...
                        {
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.NAME: 'base_model_data_process_step_record__admin',
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.MODEL_ID: ctx.get_resource_id(REF.BASE_MODEL.BASE_MODEL_DATA_PROCESS_STEP_RECORD),
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_CREATE: True,
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_READ: True,
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_UPDATE: True,
            ...
            # Administrador de permisos de usuarios
            {
                ...
                MODEL_FIELD_NAME.BASE_USER_GROUPS.ACCESS_IDS: {
                    RELATION_ACTION_NAME.CREATE: [
                        {
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.NAME: 'base_user_access__admin',
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.MODEL_ID: ctx.get_resource_id(REF.BASE_MODEL.BASE_USER_ACCESS),
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_CREATE: True,
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_READ: True,
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_UPDATE: True,
                        ...
                        {
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.NAME: 'base_user_groups__admin',
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.MODEL_ID: ctx.get_resource_id(REF.BASE_MODEL.BASE_USER_GROUPS),
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_CREATE: True,
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_READ: True,
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_UPDATE: True,
                        ...
                        {
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.NAME: 'base_users_role__admin',
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.MODEL_ID: ctx.get_resource_id(REF.BASE_MODEL.BASE_USERS_ROLE),
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_CREATE: True,
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_READ: True,
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_UPDATE: True,
                        ...
                        {
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.NAME: 'base_rules__admin',
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.MODEL_ID: ctx.get_resource_id(REF.BASE_MODEL.BASE_RULES),
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_CREATE: True,
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_READ: True,
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_UPDATE: True,
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_DELETE: True,
            ...
            # Administrador de usuarios
            {
                ...
                MODEL_FIELD_NAME.BASE_USER_GROUPS.ACCESS_IDS: {
                    RELATION_ACTION_NAME.CREATE: [
                        {
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.NAME: 'base_users__admin',
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.MODEL_ID: ctx.get_resource_id(REF.BASE_MODEL.BASE_USERS),
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_CREATE: True,
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_READ: True,
                            MODEL_FIELD_NAME.BASE_USER_ACCESS.PERM_UPDATE: True,
...
def _build_models_structure(ctx: Lylac.TransactionContext):
    ...
    ctx.create(
        ...
        [
            ...
            {
                MODEL_FIELD_NAME.BASE_MODEL.NAME: 'base_user_access',
                MODEL_FIELD_NAME.BASE_MODEL.MODEL: MODEL_NAME.BASE_USER_ACCESS,
        ...
        ctx.get_resource_id(REF.BASE_MODEL.BASE_USER_GROUPS),
        {
            MODEL_FIELD_NAME.BASE_MODEL.FIELD_IDS: {
                RELATION_ACTION_NAME.CREATE: {
                    ...
                    MODEL_FIELD_NAME.BASE_MODEL_FIELD.RELATED_MODEL_ID: ctx.get_resource_id(REF.BASE_MODEL.BASE_USER_ACCESS),
